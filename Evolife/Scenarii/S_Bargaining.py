...
""" EVOLIFE: Bargaining Scenario (after Brian Skyrms, "The stag hunt",
...
class Scenario(Default_Scenario):
	...
	def genemap(self):
		""" Defines the name of genes and their position on the DNA.
			(see Genetic_map.py)"""
		return [('signal',4),('hunt_if_0',4),('hunt_if_1',4)]
	...
	def interaction(self, indiv, others):
		...
		def signals(indiv):
			return (indiv.gene_relative_intensity('signal') > 50)
		...
		def hunts_stag(indiv,signal):
			...
			"""
	##		if signal:
	##			return noise(indiv.gene_relative_intensity('hunt_if_1'),
	##						 self.Parameter('Noise')) > 50
	##		else:
	##			return noise(indiv.gene_relative_intensity('hunt_if_0'),
	##						 self.Parameter('Noise')) > 50
