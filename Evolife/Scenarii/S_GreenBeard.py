...
class Scenario(Default_Scenario):
	...
	def interaction(self, indiv, partner):
		...
		# Read individuals' genes using "indiv.gene_intensity('GreenBeard')"
		...
		# Note that the 'Selectivity' method would (but its has other flaws) (see parameter documentation)
