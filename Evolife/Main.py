...
CfgFileName = ''
for Arg in sys.argv:
	if os.path.splitext(Arg)[1] == '.evo':
		CfgFileName = Arg
if CfgFileName == '':
	CfgFileName = 'Evolife.evo'
...
ScenarioName = ''
ScenarioName = Parameters(CfgFileName).Parameter('ScenarioName')
if ScenarioName == '':
	ScenarioName = raw_input('Name of the scenario: ')
